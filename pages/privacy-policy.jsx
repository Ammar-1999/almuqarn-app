...
export default function Home() {
  return (
    <div className="py-24">
      ...
      <p>
        This privacy policy applies to the المقارن - حساب ومقارنة الأسهم app
        (hereby referred to as "Application") for mobile devices that was
        created by DIV-1 (hereby referred to as "Service Provider") as a Free
      ...
      <p>
        ...
        lordammyor.2@gmail.com. The information that the Service Provider
      ...
      <p>
        ...
        Application, please contact them at lordammyor.2@gmail.com and they will
      ...
      <p>
        ...
        data from or market to children under the age of 3.
      </p>
      <div>
        <br />
        <p>
          The Application does not address anyone under the age of 3. The
          Service Provider does not knowingly collect personally identifiable
          information from children under 3 years of age. In the case the
          Service Provider discover that a child under 3 has provided personal
          ...
          the Service Provider (lordammyor.2@gmail.com) so that they will be
      ...
      <br />
      <p>This privacy policy is effective as of 2024-08-14</p>
      <br />
      ...
      <p>
        ...
        Provider via email at lordammyor.2@gmail.com.
      </p>
    </div>
  );
}
